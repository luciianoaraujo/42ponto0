          ...
          <div class="container">
            ...
            <div class="collapse navbar-collapse" id="custom-collapse">
              <ul class="nav navbar-nav navbar-right">
                <a class="btn btn-border-w mt-5 btn-circle" href="<?php echo BASEURL; ?>pages/login/"> <i class="icon-play"></i> > Login </a>
              
                <?php
                  if(isset($_SESSION['user'])){
                    ?>
                      <a class="btn btn-border-w mt-5 btn-circle" href="<?php echo BASEURL; ?>"> <i class="icon-play"></i> > Logout </a>
                    <?php
                  }
